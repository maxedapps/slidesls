// FROZEN v1 lint module — applies only to decks whose manifest cliVersion is
// below 0.6.0 (the v1 authoring vocabulary: ls-card/ls-panel grids). Never
// extended; deletable at 2.0. The living rules are in ../design-lint.mjs.
...
export function validateLegacyDesignComposition({ html, manifest, warnings }) {
