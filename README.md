...
The registry includes core slide assets, Batch 1 layout/component primitives, reveal-compatible animations, and optional presets such as scoped font-family remaps. Preview examples with `pnpm serve:examples`.
